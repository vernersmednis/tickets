...
- **User Roles & Permissions:**
  - **Regular Users:** Can view and edit their own tickets (legacy accounts)
  - **Agents:** Can create, view, and edit their own tickets (new user default role)
...
docker run -p 8000:80 -e APP_KEY=base64:YOUR_APP_KEY_HERE -e APP_ENV=local -e APP_DEBUG=false -e DB_CONNECTION=mysql -e DB_HOST=host.docker.internal -e DB_PORT=3306 -e DB_DATABASE=tickets -e DB_USERNAME=root -e DB_PASSWORD=root ghcr.io/vernersmednis/tickets:latest
